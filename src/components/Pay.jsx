  ...
  return (
    <div className="bg-white p-8 mt-20 lg:mr-32 flex flex-col justify-center items-center">
      ...
      <div className="lg:flex  md:flex justify-center items-center mt-8">
        <div className="bg-slate-50  p-20 lg:mr-6  md:mr-5 mb-6 lg:mb-0  text-center">
          ...
          <p className="text-sm lg:text-base text-gray-500">yenumenu@icici</p>
        </div> 
        <div className="bg-slate-50  p-20  md:mb-5 lg:mb-0 text-center">
